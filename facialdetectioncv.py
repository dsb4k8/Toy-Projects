...
if __name__=="__main__":
    ...
    face_cascade = cv2.CascadeClassifier("/YOUR/PATH/TO/FacialDetectionAlerts/haarcascade_frontalface_default.xml")

    eye_cascade  = cv2.CascadeClassifier("/YOUR/PATH/TO/FacialDetectionAlerts/haarcascade_eye.xml")

    smile_cascade = cv2.CascadeClassifier("/YOUR/PATH/TO/FacialDetectionAlerts/haarcascade_smile.xml")
